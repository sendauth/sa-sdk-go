...
func (r ApiListWebhooksRequest) Execute() ([]Webhook, *http.Response, error) {
...
// Execute executes the request
//  @return []Webhook
func (a *WebhooksAPIService) ListWebhooksExecute(r ApiListWebhooksRequest) ([]Webhook, *http.Response, error) {
	var (
...
func (r ApiUpdateWebhookRequest) WebhookInput(webhookInput WebhookInput) ApiUpdateWebhookRequest {
	r.webhookInput = &webhookInput
	return r
}
...
func (a *WebhooksAPIService) UpdateWebhookExecute(r ApiUpdateWebhookRequest) (*http.Response, error) {
	...
	localVarFormParams := url.Values{}
	if r.webhookInput == nil {
		return nil, reportError("webhookInput is required and must be specified")
	}
